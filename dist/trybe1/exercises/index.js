"use strict";
// ./index.ts
const readlinee = require('readline-sync'); // importamos o pacote readline-sync
...
const choice = readlinee.keyInSelect(scriptNames, "Escolha um número para executar o script de conversão de unidade");
